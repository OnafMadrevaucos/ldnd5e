...
const activityTypes = dnd5e.dataModels.activity;

const { DamageField } = dnd5e.dataModels.shared;
...
/**
 * Data model for an tatic activity.
 * @extends {BaseActivityData<TaticActivityData>}
 * @mixes {AttackActivityData}
 */
export default class TaticActivityData extends activityTypes.BaseActivityData {
    /** @inheritDoc */
    static defineSchema() {
        return {
            ...super.defineSchema(),
