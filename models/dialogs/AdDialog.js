                ...
                const dlg = new this(owner, item, damageType, unarmored, {
                    ...
                    buttons: {
                        da: {
                            ...
                            callback: html => resolve(onSubmitDA(html, {owner, item, damageType, unarmored}))
                        },
                        half: {
                            icon: '<i class="fas fa-shield-halved"></i>',
                            label: game.i18n.localize(i18nStrings.halfBtn),
                            callback: html => resolve(onSubmitHALF(html, {owner, item, damageType, unarmored}))
                        }
                    },
                    default: "da",
                    close: reject
                ...
                const dlg = new this(owner, item, damageType, unarmored, {
                    ...
                    buttons: {
                        ...
                        sub: {
                            ...
                            callback: html => resolve(onSubmitSUB(html, {owner, item, damageType, unarmored}))
                        },
                        zerar: {
                            icon: '<i class="fa-solid fa-heart"></i>',
                            label: game.i18n.localize(i18nStrings.zerarBtn),
                            callback: html => resolve(onSubmitZERAR(html, {owner, item, damageType, unarmored}))
                        }
                    },
                    default: "da",
                    close: reject
